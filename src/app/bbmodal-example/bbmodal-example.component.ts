...
@Component({
  selector: 'bb-modal-example-component',
  templateUrl: './bbmodal-example.component.html',
  styleUrls: ['./bbmodal-example.component.scss']
})
export class BBModalExampleComponent implements OnInit {
